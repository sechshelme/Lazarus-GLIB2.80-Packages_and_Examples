...
function g_dbus_message_new_method_error(method_call_message: PGDBusMessage; error_name: Pgchar; error_message_format: Pgchar): PGDBusMessage; varargs; cdecl; external libgio2;
