...
var
  _gst_event_type: TGType; cvar;external gstreamerlib;
...
function gst_event_replace(old_event: PPGstEvent; new_event: PGstEvent): Tgboolean; cdecl; external gstreamerlib;
function gst_event_steal(old_event: PPGstEvent): PGstEvent; cdecl; external gstreamerlib;
function gst_event_take(old_event: PPGstEvent; new_event: PGstEvent): Tgboolean; cdecl; external gstreamerlib;
...
function gst_event_type_get_name(_type: TGstEventType): Pgchar; cdecl; external gstreamerlib;
function gst_event_type_to_quark(_type: TGstEventType): TGQuark; cdecl; external gstreamerlib;
function gst_event_type_get_flags(_type: TGstEventType): TGstEventTypeFlags; cdecl; external gstreamerlib;
function gst_event_type_to_sticky_ordering(_type: TGstEventType): Tguint; cdecl; external gstreamerlib;
function gst_event_ref(event: PGstEvent): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_unref(event: PGstEvent); cdecl; external gstreamerlib;
procedure gst_clear_event(event_ptr: PPGstEvent); cdecl; external gstreamerlib;
function gst_event_copy(event: PGstEvent): PGstEvent; cdecl; external gstreamerlib;
function gst_event_get_type: TGType; cdecl; external gstreamerlib;
function gst_event_new_custom(_type: TGstEventType; structure: PGstStructure): PGstEvent; cdecl; external gstreamerlib;
function gst_event_get_structure(event: PGstEvent): PGstStructure; cdecl; external gstreamerlib;
function gst_event_writable_structure(event: PGstEvent): PGstStructure; cdecl; external gstreamerlib;
function gst_event_has_name(event: PGstEvent; Name: Pgchar): Tgboolean; cdecl; external gstreamerlib;
function gst_event_has_name_id(event: PGstEvent; Name: TGQuark): Tgboolean; cdecl; external gstreamerlib;
function gst_event_get_seqnum(event: PGstEvent): Tguint32; cdecl; external gstreamerlib;
procedure gst_event_set_seqnum(event: PGstEvent; seqnum: Tguint32); cdecl; external gstreamerlib;
function gst_event_get_running_time_offset(event: PGstEvent): Tgint64; cdecl; external gstreamerlib;
procedure gst_event_set_running_time_offset(event: PGstEvent; offset: Tgint64); cdecl; external gstreamerlib;
function gst_event_new_stream_start(stream_id: Pgchar): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_stream_start(event: PGstEvent; stream_id: PPgchar); cdecl; external gstreamerlib;
procedure gst_event_set_stream(event: PGstEvent; stream: PGstStream); cdecl; external gstreamerlib;
procedure gst_event_parse_stream(event: PGstEvent; stream: PPGstStream); cdecl; external gstreamerlib;
procedure gst_event_set_stream_flags(event: PGstEvent; flags: TGstStreamFlags); cdecl; external gstreamerlib;
procedure gst_event_parse_stream_flags(event: PGstEvent; flags: PGstStreamFlags); cdecl; external gstreamerlib;
procedure gst_event_set_group_id(event: PGstEvent; group_id: Tguint); cdecl; external gstreamerlib;
function gst_event_parse_group_id(event: PGstEvent; group_id: Pguint): Tgboolean; cdecl; external gstreamerlib;
function gst_event_new_flush_start: PGstEvent; cdecl; external gstreamerlib;
function gst_event_new_flush_stop(reset_time: Tgboolean): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_flush_stop(event: PGstEvent; reset_time: Pgboolean); cdecl; external gstreamerlib;
function gst_event_new_stream_collection(collection: PGstStreamCollection): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_stream_collection(event: PGstEvent; collection: PPGstStreamCollection); cdecl; external gstreamerlib;
function gst_event_new_select_streams(streams: PGList): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_select_streams(event: PGstEvent; streams: PPGList); cdecl; external gstreamerlib;
function gst_event_new_stream_group_done(group_id: Tguint): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_stream_group_done(event: PGstEvent; group_id: Pguint); cdecl; external gstreamerlib;
function gst_event_new_eos: PGstEvent; cdecl; external gstreamerlib;
function gst_event_new_gap(timestamp: TGstClockTime; duration: TGstClockTime): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_gap(event: PGstEvent; timestamp: PGstClockTime; duration: PGstClockTime); cdecl; external gstreamerlib;
procedure gst_event_set_gap_flags(event: PGstEvent; flags: TGstGapFlags); cdecl; external gstreamerlib;
procedure gst_event_parse_gap_flags(event: PGstEvent; flags: PGstGapFlags); cdecl; external gstreamerlib;
function gst_event_new_caps(caps: PGstCaps): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_caps(event: PGstEvent; caps: PPGstCaps); cdecl; external gstreamerlib;
function gst_event_new_segment(segment: PGstSegment): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_segment(event: PGstEvent; segment: PPGstSegment); cdecl; external gstreamerlib;
procedure gst_event_copy_segment(event: PGstEvent; segment: PGstSegment); cdecl; external gstreamerlib;
function gst_event_new_tag(taglist: PGstTagList): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_tag(event: PGstEvent; taglist: PPGstTagList); cdecl; external gstreamerlib;
function gst_event_new_toc(toc: PGstToc; updated: Tgboolean): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_toc(event: PGstEvent; toc: PPGstToc; updated: Pgboolean); cdecl; external gstreamerlib;
function gst_event_new_protection(system_id: Pgchar; Data: PGstBuffer; origin: Pgchar): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_protection(event: PGstEvent; system_id: PPgchar; Data: PPGstBuffer; origin: PPgchar); cdecl; external gstreamerlib;
function gst_event_new_buffer_size(format: TGstFormat; minsize: Tgint64; maxsize: Tgint64; async: Tgboolean): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_buffer_size(event: PGstEvent; format: PGstFormat; minsize: Pgint64; maxsize: Pgint64; async: Pgboolean); cdecl; external gstreamerlib;
// Ausgelagert
...
function gst_event_new_qos(_type: TGstQOSType; proportion: Tgdouble; diff: TGstClockTimeDiff; timestamp: TGstClockTime): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_qos(event: PGstEvent; _type: PGstQOSType; proportion: Pgdouble; diff: PGstClockTimeDiff; timestamp: PGstClockTime); cdecl; external gstreamerlib;
function gst_event_new_seek(rate: Tgdouble; format: TGstFormat; flags: TGstSeekFlags; start_type: TGstSeekType; start: Tgint64;
  stop_type: TGstSeekType; stop: Tgint64): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_seek(event: PGstEvent; rate: Pgdouble; format: PGstFormat; flags: PGstSeekFlags; start_type: PGstSeekType;
  start: Pgint64; stop_type: PGstSeekType; stop: Pgint64); cdecl; external gstreamerlib;
procedure gst_event_set_seek_trickmode_interval(event: PGstEvent; interval: TGstClockTime); cdecl; external gstreamerlib;
procedure gst_event_parse_seek_trickmode_interval(event: PGstEvent; interval: PGstClockTime); cdecl; external gstreamerlib;
function gst_event_new_navigation(structure: PGstStructure): PGstEvent; cdecl; external gstreamerlib;
function gst_event_new_latency(latency: TGstClockTime): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_latency(event: PGstEvent; latency: PGstClockTime); cdecl; external gstreamerlib;
function gst_event_new_step(format: TGstFormat; amount: Tguint64; rate: Tgdouble; flush: Tgboolean; intermediate: Tgboolean): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_step(event: PGstEvent; format: PGstFormat; amount: Pguint64; rate: Pgdouble; flush: Pgboolean;
  intermediate: Pgboolean); cdecl; external gstreamerlib;
function gst_event_new_reconfigure: PGstEvent; cdecl; external gstreamerlib;
function gst_event_new_toc_select(uid: Pgchar): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_toc_select(event: PGstEvent; uid: PPgchar); cdecl; external gstreamerlib;
function gst_event_new_segment_done(format: TGstFormat; position: Tgint64): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_segment_done(event: PGstEvent; format: PGstFormat; position: Pgint64); cdecl; external gstreamerlib;
function gst_event_new_instant_rate_change(rate_multiplier: Tgdouble; new_flags: TGstSegmentFlags): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_instant_rate_change(event: PGstEvent; rate_multiplier: Pgdouble; new_flags: PGstSegmentFlags); cdecl; external gstreamerlib;
function gst_event_new_instant_rate_sync_time(rate_multiplier: Tgdouble; running_time: TGstClockTime; upstream_running_time: TGstClockTime): PGstEvent; cdecl; external gstreamerlib;
procedure gst_event_parse_instant_rate_sync_time(event: PGstEvent; rate_multiplier: Pgdouble; running_time: PGstClockTime; upstream_running_time: PGstClockTime); cdecl; external gstreamerlib;

function GST_TYPE_EVENT: TGType;

function GST_EVENT_MAKE_TYPE(num, flags: Tguint32): Tguint32;

function GST_IS_EVENT(obj: TGType): Tgboolean;
