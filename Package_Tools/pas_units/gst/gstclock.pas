...
function gst_clock_set_resolution(clock: PGstClock; resolution: TGstClockTime): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_get_resolution(clock: PGstClock): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_get_time(clock: PGstClock): TGstClockTime; cdecl; external gstreamerlib;
procedure gst_clock_set_calibration(clock: PGstClock; internal: TGstClockTime; external: TGstClockTime; rate_num: TGstClockTime; rate_denom: TGstClockTime); cdecl; external gstreamerlib;
procedure gst_clock_get_calibration(clock: PGstClock; internal: PGstClockTime; external: PGstClockTime; rate_num: PGstClockTime; rate_denom: PGstClockTime); cdecl; external gstreamerlib;
function gst_clock_set_master(clock: PGstClock; master: PGstClock): Tgboolean; cdecl; external gstreamerlib;
function gst_clock_get_master(clock: PGstClock): PGstClock; cdecl; external gstreamerlib;
procedure gst_clock_set_timeout(clock: PGstClock; timeout: TGstClockTime); cdecl; external gstreamerlib;
function gst_clock_get_timeout(clock: PGstClock): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_add_observation(clock: PGstClock; slave: TGstClockTime; master: TGstClockTime; r_squared: Pgdouble): Tgboolean; cdecl; external gstreamerlib;
function gst_clock_add_observation_unapplied(clock: PGstClock; slave: TGstClockTime; master: TGstClockTime; r_squared: Pgdouble; internal: PGstClockTime;
  external: PGstClockTime; rate_num: PGstClockTime; rate_denom: PGstClockTime): Tgboolean; cdecl; external gstreamerlib;
function gst_clock_get_internal_time(clock: PGstClock): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_adjust_unlocked(clock: PGstClock; internal: TGstClockTime): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_adjust_with_calibration(clock: PGstClock; internal_target: TGstClockTime; cinternal: TGstClockTime; cexternal: TGstClockTime; cnum: TGstClockTime;
  cdenom: TGstClockTime): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_unadjust_with_calibration(clock: PGstClock; external_target: TGstClockTime; cinternal: TGstClockTime; cexternal: TGstClockTime; cnum: TGstClockTime;
  cdenom: TGstClockTime): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_unadjust_unlocked(clock: PGstClock; external: TGstClockTime): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_wait_for_sync(clock: PGstClock; timeout: TGstClockTime): Tgboolean; cdecl; external gstreamerlib;
function gst_clock_is_synced(clock: PGstClock): Tgboolean; cdecl; external gstreamerlib;
procedure gst_clock_set_synced(clock: PGstClock; synced: Tgboolean); cdecl; external gstreamerlib;
function gst_clock_new_single_shot_id(clock: PGstClock; time: TGstClockTime): TGstClockID; cdecl; external gstreamerlib;
function gst_clock_new_periodic_id(clock: PGstClock; start_time: TGstClockTime; interval: TGstClockTime): TGstClockID; cdecl; external gstreamerlib;
function gst_clock_id_ref(id: TGstClockID): TGstClockID; cdecl; external gstreamerlib;
procedure gst_clock_id_unref(id: TGstClockID); cdecl; external gstreamerlib;
function gst_clock_id_compare_func(id1: Tgconstpointer; id2: Tgconstpointer): Tgint; cdecl; external gstreamerlib;
function gst_clock_id_get_clock(id: TGstClockID): PGstClock; cdecl; external gstreamerlib;
function gst_clock_id_uses_clock(id: TGstClockID; clock: PGstClock): Tgboolean; cdecl; external gstreamerlib;
function gst_clock_id_get_time(id: TGstClockID): TGstClockTime; cdecl; external gstreamerlib;
function gst_clock_id_wait(id: TGstClockID; jitter: PGstClockTimeDiff): TGstClockReturn; cdecl; external gstreamerlib;
function gst_clock_id_wait_async(id: TGstClockID; func: TGstClockCallback; user_data: Tgpointer; destroy_data: TGDestroyNotify): TGstClockReturn; cdecl; external gstreamerlib;
procedure gst_clock_id_unschedule(id: TGstClockID); cdecl; external gstreamerlib;
function gst_clock_single_shot_id_reinit(clock: PGstClock; id: TGstClockID; time: TGstClockTime): Tgboolean; cdecl; external gstreamerlib;
function gst_clock_periodic_id_reinit(clock: PGstClock; id: TGstClockID; start_time: TGstClockTime; interval: TGstClockTime): Tgboolean; cdecl; external gstreamerlib;
