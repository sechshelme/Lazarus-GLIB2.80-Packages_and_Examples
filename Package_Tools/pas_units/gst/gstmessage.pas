...
uses
  glib280, common_GST, gstobject, gststructure, gstminiobject, gsttaglist, gstquery, gstformat, gstclock, gsttoc, gstcontext, gstevent, gstdevice, gststreamcollection;
...
function GST_IS_MESSAGE(obj: TGType): Tgboolean;
