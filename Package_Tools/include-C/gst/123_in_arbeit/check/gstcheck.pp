...
{
  Automatically converted by H2Pas 1.0.0 from gstcheck.h
...
PGstCaps  = ^GstCaps;
PGstCheckABIStruct  = ^GstCheckABIStruct;
PGstCheckLogFilter  = ^GstCheckLogFilter;
...
procedure gst_check_init(argc:Plongint; argv:PPPchar);cdecl;external;
(* Const before type ignored *)
function gst_check_add_log_filter(log_domain:Pgchar; log_level:TGLogLevelFlags; regex:PGRegex; func:TGstCheckLogFilterFunc; user_data:Tgpointer; 
           destroy_data:TGDestroyNotify):PGstCheckLogFilter;cdecl;external;
procedure gst_check_remove_log_filter(filter:PGstCheckLogFilter);cdecl;external;
procedure gst_check_clear_log_filter;cdecl;external;
function gst_check_chain_func(pad:PGstPad; parent:PGstObject; buffer:PGstBuffer):TGstFlowReturn;cdecl;external;
procedure gst_check_message_error(message:PGstMessage; _type:TGstMessageType; domain:TGQuark; code:Tgint);cdecl;external;
(* Const before type ignored *)
function gst_check_setup_element(factory:Pgchar):PGstElement;cdecl;external;
procedure gst_check_teardown_element(element:PGstElement);cdecl;external;
function gst_check_setup_src_pad(element:PGstElement; tmpl:PGstStaticPadTemplate):PGstPad;cdecl;external;
function gst_check_setup_src_pad_from_template(element:PGstElement; tmpl:PGstPadTemplate):PGstPad;cdecl;external;
(* Const before type ignored *)
function gst_check_setup_src_pad_by_name(element:PGstElement; tmpl:PGstStaticPadTemplate; name:Pgchar):PGstPad;cdecl;external;
(* Const before type ignored *)
function gst_check_setup_src_pad_by_name_from_template(element:PGstElement; tmpl:PGstPadTemplate; name:Pgchar):PGstPad;cdecl;external;
function gst_check_setup_sink_pad(element:PGstElement; tmpl:PGstStaticPadTemplate):PGstPad;cdecl;external;
function gst_check_setup_sink_pad_from_template(element:PGstElement; tmpl:PGstPadTemplate):PGstPad;cdecl;external;
(* Const before type ignored *)
function gst_check_setup_sink_pad_by_name(element:PGstElement; tmpl:PGstStaticPadTemplate; name:Pgchar):PGstPad;cdecl;external;
(* Const before type ignored *)
function gst_check_setup_sink_pad_by_name_from_template(element:PGstElement; tmpl:PGstPadTemplate; name:Pgchar):PGstPad;cdecl;external;
(* Const before type ignored *)
procedure gst_check_teardown_pad_by_name(element:PGstElement; name:Pgchar);cdecl;external;
procedure gst_check_teardown_src_pad(element:PGstElement);cdecl;external;
procedure gst_check_drop_buffers;cdecl;external;
procedure gst_check_caps_equal(caps1:PGstCaps; caps2:PGstCaps);cdecl;external;
procedure gst_check_buffer_data(buffer:PGstBuffer; data:Tgconstpointer; size:Tgsize);cdecl;external;
(* Const before type ignored *)
procedure gst_check_element_push_buffer_list(element_name:Pgchar; buffer_in:PGList; caps_in:PGstCaps; buffer_out:PGList; caps_out:PGstCaps; 
            last_flow_return:TGstFlowReturn);cdecl;external;
(* Const before type ignored *)
procedure gst_check_element_push_buffer(element_name:Pgchar; buffer_in:PGstBuffer; caps_in:PGstCaps; buffer_out:PGstBuffer; caps_out:PGstCaps);cdecl;external;
procedure gst_check_teardown_sink_pad(element:PGstElement);cdecl;external;
procedure gst_check_abi_list(list:PGstCheckABIStruct; have_abi_sizes:Tgboolean);cdecl;external;
(* Const before type ignored *)
(* Const before type ignored *)
function gst_check_run_suite(suite:PSuite; name:Pgchar; fname:Pgchar):Tgint;cdecl;external;
procedure gst_check_setup_events(srcpad:PGstPad; element:PGstElement; caps:PGstCaps; format:TGstFormat);cdecl;external;
(* Const before type ignored *)
procedure gst_check_setup_events_with_stream_id(srcpad:PGstPad; element:PGstElement; caps:PGstCaps; format:TGstFormat; stream_id:Pgchar);cdecl;external;
procedure gst_check_objects_destroyed_on_unref(object_to_unref:Tgpointer; first_object:Tgpointer; args:array of const);cdecl;external;
procedure gst_check_objects_destroyed_on_unref(object_to_unref:Tgpointer; first_object:Tgpointer);cdecl;external;
procedure gst_check_object_destroyed_on_unref(object_to_unref:Tgpointer);cdecl;external;
{*
 * GST_START_TEST:
...
(* Const before type ignored *)
function _gst_check_run_test_func(func_name:Pgchar):Tgboolean;cdecl;external;
const
