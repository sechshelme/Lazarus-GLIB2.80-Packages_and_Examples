...
{
  Automatically converted by H2Pas 0.99.16 from gstnetclientclock.h
...
function GST_TYPE_NET_CLIENT_CLOCK : longint; { return type might be wrong }

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function GST_NET_CLIENT_CLOCK(obj : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function GST_NET_CLIENT_CLOCK_CLASS(klass : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function GST_IS_NET_CLIENT_CLOCK(obj : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function GST_IS_NET_CLIENT_CLOCK_CLASS(klass : longint) : longint;
...
function gst_net_client_clock_get_type:TGType;cdecl;external;
(* Const before declarator ignored *)
(* Const before declarator ignored *)
function gst_net_client_clock_new(name:Pgchar; remote_address:Pgchar; remote_port:Tgint; base_time:TGstClockTime):PGstClock;cdecl;external;
{ was #define dname def_expr }
...
function GST_NET_CLIENT_CLOCK(obj : longint) : longint;
begin
  GST_NET_CLIENT_CLOCK:=G_TYPE_CHECK_INSTANCE_CAST(obj,GST_TYPE_NET_CLIENT_CLOCK,GstNetClientClock);
end;
...
function GST_NET_CLIENT_CLOCK_CLASS(klass : longint) : longint;
begin
  GST_NET_CLIENT_CLOCK_CLASS:=G_TYPE_CHECK_CLASS_CAST(klass,GST_TYPE_NET_CLIENT_CLOCK,GstNetClientClockClass);
end;
...
function GST_IS_NET_CLIENT_CLOCK(obj : longint) : longint;
begin
  GST_IS_NET_CLIENT_CLOCK:=G_TYPE_CHECK_INSTANCE_TYPE(obj,GST_TYPE_NET_CLIENT_CLOCK);
end;
...
function GST_IS_NET_CLIENT_CLOCK_CLASS(klass : longint) : longint;
begin
  GST_IS_NET_CLIENT_CLOCK_CLASS:=G_TYPE_CHECK_CLASS_TYPE(klass,GST_TYPE_NET_CLIENT_CLOCK);
end;
