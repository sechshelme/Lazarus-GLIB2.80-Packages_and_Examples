 ...
 * @since 0.11.0
 * */
 void  tcase_set_tags (TCase * tc, const char *tags);
/**
...
*/
 void  _tcase_add_test (TCase * tc, TFun tf,
 ...
 * @since 0.8.0
 */
 void  tcase_add_unchecked_fixture (TCase * tc, SFun setup,
    SFun teardown);
 ...
 * @since 0.8.0
*/
 void  tcase_add_checked_fixture (TCase * tc, SFun setup,
    SFun teardown);
 ...
 * @since 0.6.0
 */
 void  srunner_run_all (SRunner * sr,
 ...
 * @since 0.9.9
 */
 void  srunner_run (SRunner * sr, const char *sname,
 ...
 * @since 0.11.0
 */
 void  srunner_run_tagged (SRunner * sr, const char *sname,
    const char *tcname,
 ...
 * @since 0.8.0
 */
 void  srunner_set_fork_status (SRunner * sr,
