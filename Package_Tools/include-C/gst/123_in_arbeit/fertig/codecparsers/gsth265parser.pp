...
{
  Automatically converted by H2Pas 1.0.0 from gsth265parser.h
...
PGstH265BufferingPeriod  = ^GstH265BufferingPeriod;
PGstH265ContentLightLevel  = ^GstH265ContentLightLevel;
PGstH265DecoderConfigRecord  = ^GstH265DecoderConfigRecord;
PGstH265DecoderConfigRecordNalUnitArray  = ^GstH265DecoderConfigRecordNalUnitArray;
PGstH265HRDParams  = ^GstH265HRDParams;
PGstH265Level  = ^GstH265Level;
PGstH265MasteringDisplayColourVolume  = ^GstH265MasteringDisplayColourVolume;
PGstH265NalUnit  = ^GstH265NalUnit;
PGstH265NalUnitType  = ^GstH265NalUnitType;
PGstH265Parser  = ^GstH265Parser;
PGstH265ParserResult  = ^GstH265ParserResult;
PGstH265PicTiming  = ^GstH265PicTiming;
PGstH265PPS  = ^GstH265PPS;
PGstH265PPSExtensionParams  = ^GstH265PPSExtensionParams;
PGstH265PPSSccExtensionParams  = ^GstH265PPSSccExtensionParams;
PGstH265PredWeightTable  = ^GstH265PredWeightTable;
PGstH265Profile  = ^GstH265Profile;
PGstH265ProfileIDC  = ^GstH265ProfileIDC;
PGstH265ProfileTierLevel  = ^GstH265ProfileTierLevel;
PGstH265QuantMatrixSize  = ^GstH265QuantMatrixSize;
PGstH265RecoveryPoint  = ^GstH265RecoveryPoint;
PGstH265RefPicListModification  = ^GstH265RefPicListModification;
PGstH265RegisteredUserData  = ^GstH265RegisteredUserData;
PGstH265ScalingList  = ^GstH265ScalingList;
PGstH265SEIMessage  = ^GstH265SEIMessage;
PGstH265SEIPayloadType  = ^GstH265SEIPayloadType;
PGstH265SEIPicStructType  = ^GstH265SEIPicStructType;
PGstH265ShortTermRefPicSet  = ^GstH265ShortTermRefPicSet;
PGstH265SliceHdr  = ^GstH265SliceHdr;
PGstH265SliceType  = ^GstH265SliceType;
PGstH265SPS  = ^GstH265SPS;
PGstH265SPSExtensionParams  = ^GstH265SPSExtensionParams;
PGstH265SPSSccExtensionParams  = ^GstH265SPSSccExtensionParams;
PGstH265SubLayerHRDParams  = ^GstH265SubLayerHRDParams;
PGstH265TimeCode  = ^GstH265TimeCode;
PGstH265UserDataUnregistered  = ^GstH265UserDataUnregistered;
PGstH265VPS  = ^GstH265VPS;
PGstH265VUIParams  = ^GstH265VUIParams;
...
function gst_h265_parser_new:PGstH265Parser;cdecl;external;
(* Const before type ignored *)
function gst_h265_parser_identify_nalu(parser:PGstH265Parser; data:Pguint8; offset:Tguint; size:Tgsize; nalu:PGstH265NalUnit):TGstH265ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_h265_parser_identify_nalu_unchecked(parser:PGstH265Parser; data:Pguint8; offset:Tguint; size:Tgsize; nalu:PGstH265NalUnit):TGstH265ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_h265_parser_identify_nalu_hevc(parser:PGstH265Parser; data:Pguint8; offset:Tguint; size:Tgsize; nal_length_size:Tguint8; 
           nalu:PGstH265NalUnit):TGstH265ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_h265_parser_identify_and_split_nalu_hevc(parser:PGstH265Parser; data:Pguint8; offset:Tguint; size:Tgsize; nal_length_size:Tguint8; 
           nalus:PGArray; consumed:Pgsize):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_parse_nal(parser:PGstH265Parser; nalu:PGstH265NalUnit):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_parse_slice_hdr(parser:PGstH265Parser; nalu:PGstH265NalUnit; slice:PGstH265SliceHdr):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_parse_vps(parser:PGstH265Parser; nalu:PGstH265NalUnit; vps:PGstH265VPS):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_parse_sps(parser:PGstH265Parser; nalu:PGstH265NalUnit; sps:PGstH265SPS; parse_vui_params:Tgboolean):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_parse_pps(parser:PGstH265Parser; nalu:PGstH265NalUnit; pps:PGstH265PPS):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_parse_sei(parser:PGstH265Parser; nalu:PGstH265NalUnit; messages:PPGArray):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_update_vps(parser:PGstH265Parser; vps:PGstH265VPS):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_update_sps(parser:PGstH265Parser; sps:PGstH265SPS):TGstH265ParserResult;cdecl;external;
function gst_h265_parser_update_pps(parser:PGstH265Parser; pps:PGstH265PPS):TGstH265ParserResult;cdecl;external;
procedure gst_h265_parser_free(parser:PGstH265Parser);cdecl;external;
function gst_h265_parse_vps(nalu:PGstH265NalUnit; vps:PGstH265VPS):TGstH265ParserResult;cdecl;external;
function gst_h265_parse_sps(parser:PGstH265Parser; nalu:PGstH265NalUnit; sps:PGstH265SPS; parse_vui_params:Tgboolean):TGstH265ParserResult;cdecl;external;
function gst_h265_parse_pps(parser:PGstH265Parser; nalu:PGstH265NalUnit; pps:PGstH265PPS):TGstH265ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_h265_slice_hdr_copy(dst_slice:PGstH265SliceHdr; src_slice:PGstH265SliceHdr):Tgboolean;cdecl;external;
procedure gst_h265_slice_hdr_free(slice_hdr:PGstH265SliceHdr);cdecl;external;
(* Const before type ignored *)
function gst_h265_sei_copy(dest_sei:PGstH265SEIMessage; src_sei:PGstH265SEIMessage):Tgboolean;cdecl;external;
procedure gst_h265_sei_free(sei:PGstH265SEIMessage);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_4x4_get_zigzag_from_raster(out_quant:array[0..15] of Tguint8; quant:array[0..15] of Tguint8);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_4x4_get_raster_from_zigzag(out_quant:array[0..15] of Tguint8; quant:array[0..15] of Tguint8);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_8x8_get_zigzag_from_raster(out_quant:array[0..63] of Tguint8; quant:array[0..63] of Tguint8);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_8x8_get_raster_from_zigzag(out_quant:array[0..63] of Tguint8; quant:array[0..63] of Tguint8);cdecl;external;
const
...
procedure gst_h265_quant_matrix_4x4_get_uprightdiagonal_from_raster(out_quant:array[0..15] of Tguint8; quant:array[0..15] of Tguint8);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_4x4_get_raster_from_uprightdiagonal(out_quant:array[0..15] of Tguint8; quant:array[0..15] of Tguint8);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_8x8_get_uprightdiagonal_from_raster(out_quant:array[0..63] of Tguint8; quant:array[0..63] of Tguint8);cdecl;external;
(* Const before type ignored *)
procedure gst_h265_quant_matrix_8x8_get_raster_from_uprightdiagonal(out_quant:array[0..63] of Tguint8; quant:array[0..63] of Tguint8);cdecl;external;
const
...
function gst_h265_profile_tier_level_get_profile(ptl:PGstH265ProfileTierLevel):TGstH265Profile;cdecl;external;
(* Const before type ignored *)
function gst_h265_profile_to_string(profile:TGstH265Profile):Pgchar;cdecl;external;
(* Const before type ignored *)
function gst_h265_profile_from_string(_string:Pgchar):TGstH265Profile;cdecl;external;
(* Const before type ignored *)
function gst_h265_slice_type_to_string(slice_type:TGstH265SliceType):Pgchar;cdecl;external;
function gst_h265_create_sei_memory(layer_id:Tguint8; temporal_id_plus1:Tguint8; start_code_prefix_length:Tguint8; messages:PGArray):PGstMemory;cdecl;external;
function gst_h265_create_sei_memory_hevc(layer_id:Tguint8; temporal_id_plus1:Tguint8; nal_length_size:Tguint8; messages:PGArray):PGstMemory;cdecl;external;
function gst_h265_parser_insert_sei(parser:PGstH265Parser; au:PGstBuffer; sei:PGstMemory):PGstBuffer;cdecl;external;
function gst_h265_parser_insert_sei_hevc(parser:PGstH265Parser; nal_length_size:Tguint8; au:PGstBuffer; sei:PGstMemory):PGstBuffer;cdecl;external;
function gst_h265_get_profile_from_sps(sps:PGstH265SPS):TGstH265Profile;cdecl;external;
procedure gst_h265_decoder_config_record_free(config:PGstH265DecoderConfigRecord);cdecl;external;
(* Const before type ignored *)
function gst_h265_parser_parse_decoder_config_record(parser:PGstH265Parser; data:Pguint8; size:Tgsize; config:PPGstH265DecoderConfigRecord):TGstH265ParserResult;cdecl;external;
{$endif}
