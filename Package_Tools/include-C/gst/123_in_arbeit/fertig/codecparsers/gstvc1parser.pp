...
{
  Automatically converted by H2Pas 1.0.0 from gstvc1parser.h
...
Type
PGstVC1AdvancedSeqHdr  = ^GstVC1AdvancedSeqHdr;
PGstVC1BDU  = ^GstVC1BDU;
PGstVC1BitPlanes  = ^GstVC1BitPlanes;
PGstVC1Condover  = ^GstVC1Condover;
PGstVC1DQProfile  = ^GstVC1DQProfile;
PGstVC1EntryPointHdr  = ^GstVC1EntryPointHdr;
PGstVC1FrameCodingMode  = ^GstVC1FrameCodingMode;
PGstVC1FrameHdr  = ^GstVC1FrameHdr;
PGstVC1FrameLayer  = ^GstVC1FrameLayer;
PGstVC1HrdParam  = ^GstVC1HrdParam;
PGstVC1Level  = ^GstVC1Level;
PGstVC1MvMode  = ^GstVC1MvMode;
PGstVC1ParserResult  = ^GstVC1ParserResult;
PGstVC1PicAdvanced  = ^GstVC1PicAdvanced;
PGstVC1PicSimpleMain  = ^GstVC1PicSimpleMain;
PGstVC1PictureType  = ^GstVC1PictureType;
PGstVC1Profile  = ^GstVC1Profile;
PGstVC1QuantizerSpec  = ^GstVC1QuantizerSpec;
PGstVC1SeqHdr  = ^GstVC1SeqHdr;
PGstVC1SeqLayer  = ^GstVC1SeqLayer;
PGstVC1SeqStructA  = ^GstVC1SeqStructA;
PGstVC1SeqStructB  = ^GstVC1SeqStructB;
PGstVC1SeqStructC  = ^GstVC1SeqStructC;
PGstVC1SliceHdr  = ^GstVC1SliceHdr;
PGstVC1StartCode  = ^GstVC1StartCode;
PGstVC1VopDquant  = ^GstVC1VopDquant;
Pguint8  = ^guint8;
{$IFDEF FPC}
{$PACKRECORDS C}
{$ENDIF}
...
function gst_vc1_identify_next_bdu(data:Pguint8; size:Tgsize; bdu:PGstVC1BDU):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_sequence_header(data:Pguint8; size:Tgsize; seqhdr:PGstVC1SeqHdr):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_entry_point_header(data:Pguint8; size:Tgsize; entrypoint:PGstVC1EntryPointHdr; seqhdr:PGstVC1SeqHdr):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_sequence_layer(data:Pguint8; size:Tgsize; seqlayer:PGstVC1SeqLayer):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_sequence_header_struct_a(data:Pguint8; size:Tgsize; structa:PGstVC1SeqStructA):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_sequence_header_struct_b(data:Pguint8; size:Tgsize; structb:PGstVC1SeqStructB):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_sequence_header_struct_c(data:Pguint8; size:Tgsize; structc:PGstVC1SeqStructC):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_frame_layer(data:Pguint8; size:Tgsize; framelayer:PGstVC1FrameLayer):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_frame_header(data:Pguint8; size:Tgsize; framehdr:PGstVC1FrameHdr; seqhdr:PGstVC1SeqHdr; bitplanes:PGstVC1BitPlanes):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_field_header(data:Pguint8; size:Tgsize; fieldhdr:PGstVC1FrameHdr; seqhdr:PGstVC1SeqHdr; bitplanes:PGstVC1BitPlanes):TGstVC1ParserResult;cdecl;external;
(* Const before type ignored *)
function gst_vc1_parse_slice_header(data:Pguint8; size:Tgsize; slicehdr:PGstVC1SliceHdr; seqhdr:PGstVC1SeqHdr):TGstVC1ParserResult;cdecl;external;
function gst_vc1_bitplanes_new:PGstVC1BitPlanes;cdecl;external;
procedure gst_vc1_bitplanes_free(bitplanes:PGstVC1BitPlanes);cdecl;external;
procedure gst_vc1_bitplanes_free_1(bitplanes:PGstVC1BitPlanes);cdecl;external;
function gst_vc1_bitplanes_ensure_size(bitplanes:PGstVC1BitPlanes; seqhdr:PGstVC1SeqHdr):Tgboolean;cdecl;external;
{$endif}
