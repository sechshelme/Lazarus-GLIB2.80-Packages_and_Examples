...
procedure gst_mpeg_video_quant_matrix_get_raster_from_zigzag(out_quant:array[0..63] of Tguint8; quant:array[0..63] of Tguint8);cdecl;external libgstcodecparsers;
procedure gst_mpeg_video_quant_matrix_get_zigzag_from_raster(out_quant:array[0..63] of Tguint8; quant:array[0..63] of Tguint8);cdecl;external libgstcodecparsers;
{$endif}
