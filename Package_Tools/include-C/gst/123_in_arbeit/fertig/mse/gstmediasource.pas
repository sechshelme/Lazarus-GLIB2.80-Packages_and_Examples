...
function gst_media_source_set_live_seekable_range(self:PGstMediaSource; start:TGstClockTime; end:TGstClockTime; error:PPGError):Tgboolean;cdecl;external libgstmse;
...
function gst_media_source_get_type: TGType; cdecl; external libgxxxxxxx;
