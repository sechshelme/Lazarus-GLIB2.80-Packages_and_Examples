...
{
  Automatically converted by H2Pas 0.99.16 from gstvkhandle.h
...
function gst_vulkan_handle_get_type:TGType;cdecl;external;
{*
...
function GST_TYPE_VULKAN_HANDLE : longint; { return type might be wrong }
...
function gst_vulkan_handle_new_wrapped(device:PGstVulkanDevice; _type:TGstVulkanHandleType; handle:TGstVulkanHandleTypedef; notify:TGstVulkanHandleDestroyNotify; user_data:Tgpointer):PGstVulkanHandle;cdecl;external;
procedure gst_vulkan_handle_free_descriptor_set_layout(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
procedure gst_vulkan_handle_free_pipeline_layout(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
procedure gst_vulkan_handle_free_pipeline(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
procedure gst_vulkan_handle_free_render_pass(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
procedure gst_vulkan_handle_free_sampler(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
procedure gst_vulkan_handle_free_framebuffer(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
procedure gst_vulkan_handle_free_shader(handle:PGstVulkanHandle; user_data:Tgpointer);cdecl;external;
{$endif}
